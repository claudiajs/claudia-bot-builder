...
function sendReply(conversationId, activity, contextId, authToken){
  console.log('before reply ', conversationId, activity, contextId, authToken);
  ...
  console.log(options);
  return rp.post(`https://skype.botframework.com/v3/conversations/${conversationId}/activities`, options);
}
